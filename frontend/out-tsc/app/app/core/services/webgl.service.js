...
let WebGLService = class WebGLService {
    constructor(ngZone) {
        ...
        this.gpuTier = 2; // Default to medium
        this.clock = new THREE.Clock();
        // Smooth mouse coordinates
        this.mouse = { x: 0, y: 0, targetX: 0, targetY: 0 };
        this.scroll = { current: 0, target: 0, speed: 0 };
        this.isLowTier = false;
        this.onResize = () => {
    ...
    updateScroll(scrollTop, velocity = 0) {
...
export { WebGLService };
//# sourceMappingURL=webgl.service.js.map