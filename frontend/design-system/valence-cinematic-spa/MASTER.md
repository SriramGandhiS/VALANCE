...
**Project:** Valence Cinematic SPA
**Generated:** 2026-05-24 17:51:44
...
- FAIL: **Emojis as icons** — Use SVG icons (Heroicons, Lucide, Simple Icons)
- FAIL: **Missing cursor:pointer** — All clickable elements must have cursor:pointer
- FAIL: **Layout-shifting hovers** — Avoid scale transforms that shift layout
- FAIL: **Low contrast text** — Maintain 4.5:1 minimum contrast ratio
- FAIL: **Instant state changes** — Always use transitions (150-300ms)
- FAIL: **Invisible focus states** — Focus states must be visible for a11y
